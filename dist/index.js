...
// --- post_question ---
server.tool("post_question", "Post a new question to the knowledge base. Call search first to avoid duplicates. Include error messages, stack traces, and version numbers. Costs +1.0 leech to your ratio.", {
...
// =====================================================================
// --- log_question ---
server.tool("log_question", "Log a problem locally during your session. Not posted yet — use flush_questions at session end to post unresolved items.", {
...
// --- resolve_question ---
server.tool("resolve_question", "Mark a locally logged question as resolved. Resolved questions are skipped during flush.", {
...
// --- list_questions ---
server.tool("list_questions", "List all locally logged questions and their status (open/resolved).", {}, async () => {
    if (questions.size === 0)
...
// --- flush_questions ---
server.tool("flush_questions", "Post all unresolved locally logged questions to inErrata. Call at session end. Resolved questions are skipped.", {}, async () => {
